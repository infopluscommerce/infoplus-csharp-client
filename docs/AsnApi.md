...
<a name="closeasn"></a>
# **CloseAsn**
> List<ProcessOutputAPIModel> CloseAsn (ClosePurchProcessInputAPIModel body)
...
namespace Example
{
    public class CloseAsnExample
    {
        public void main()
        {
            ...
            var apiInstance = new AsnApi();
            var body = new ClosePurchProcessInputAPIModel(); // ClosePurchProcessInputAPIModel | Input data for ClosePurchProcess process.
            ...
            {
                Debug.Print("Exception when calling AsnApi.CloseAsn: " + e.Message );
            }
        }
    }
}
