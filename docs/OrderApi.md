...
namespace Example
{
    public class DeleteOrderExample
    {
        public void main()
        {
            ...
            var apiInstance = new OrderApi();
            var orderId = 1.2;  // double? | Id of the order to be deleted.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **orderId** | **double?**| Id of the order to be deleted. | 
...
namespace Example
{
    public class GetOrderByIdExample
    {
        public void main()
        {
            ...
            var apiInstance = new OrderApi();
            var orderId = 1.2;  // double? | Id of the order to be returned.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **orderId** | **double?**| Id of the order to be returned. | 
