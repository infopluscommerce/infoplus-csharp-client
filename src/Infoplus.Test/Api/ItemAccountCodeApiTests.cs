...
namespace Infoplus.Test
{
    ...
    public class ItemAccountCodeApiTests
    {
        ...
        {
            // test 'IsInstanceOfType' ItemAccountCodeApi
            Assert.IsInstanceOfType(typeof(ItemAccountCodeApi), instance, "instance is a ItemAccountCodeApi");
        }

        
        /// <summary>
        /// Test GetItemAccountCodeBySearchText
        /// </summary>
        [Test]
        public void GetItemAccountCodeBySearchTextTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string searchText = null;
            //int? page = null;
            //int? limit = null;
            //var response = instance.GetItemAccountCodeBySearchText(searchText, page, limit);
            //Assert.IsInstanceOf<List<ItemAccountCode>> (response, "response is List<ItemAccountCode>");
        }
        
        /// <summary>
        /// Test GetTranslateAccountCodeById
        /// </summary>
        [Test]
        public void GetTranslateAccountCodeByIdTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string itemAccountCodeId = null;
            //var response = instance.GetTranslateAccountCodeById(itemAccountCodeId);
