...
namespace Infoplus.Test
{
    ...
    public class ItemProductCodeApiTests
    {
        ...
        {
            // test 'IsInstanceOfType' ItemProductCodeApi
            Assert.IsInstanceOfType(typeof(ItemProductCodeApi), instance, "instance is a ItemProductCodeApi");
        }

        
        /// <summary>
        /// Test GetItemProductCodeBySearchText
        /// </summary>
        [Test]
        public void GetItemProductCodeBySearchTextTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string searchText = null;
            //int? page = null;
            //int? limit = null;
            //var response = instance.GetItemProductCodeBySearchText(searchText, page, limit);
            //Assert.IsInstanceOf<List<ItemProductCode>> (response, "response is List<ItemProductCode>");
        }
        
        /// <summary>
        /// Test GetTranslateProductCodeById
        /// </summary>
        [Test]
        public void GetTranslateProductCodeByIdTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string itemProductCodeId = null;
            //var response = instance.GetTranslateProductCodeById(itemProductCodeId);
