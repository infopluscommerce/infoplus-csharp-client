...
namespace Infoplus.Test
{
    ...
    public class ProductTypeApiTests
    {
        ...
        public void GetProductTypeByIdTest()
        {
            ...
            //var response = instance.GetProductTypeById(productTypeId);
            //Assert.IsInstanceOf<ProductType> (response, "response is ProductType");
        }
        
        /// <summary>
        /// Test GetProductTypeBySearchText
        /// </summary>
        [Test]
        public void GetProductTypeBySearchTextTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string searchText = null;
            //int? page = null;
            //int? limit = null;
            //var response = instance.GetProductTypeBySearchText(searchText, page, limit);
