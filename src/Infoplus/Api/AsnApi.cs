...
namespace Infoplus.Api
{
    ...
    public interface IAsnApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Infoplus.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">Input data for ClosePurchProcess process.</param>
        ...
        ApiResponse<List<ProcessOutputAPIModel>> CloseAsnWithHttpInfo (ClosePurchProcessInputAPIModel body);
        /// <summary>
        /// Delete an asn
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<ProcessOutputAPIModel>> CloseAsnAsync (ClosePurchProcessInputAPIModel body);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<ProcessOutputAPIModel>>> CloseAsnAsyncWithHttpInfo (ClosePurchProcessInputAPIModel body);
        /// <summary>
        /// Delete an asn
        /// </summary>
        /// <remarks>
    ...
    public partial class AsnApi : IAsnApi
    {
        ...
        /// <param name="body">Input data for ClosePurchProcess process.</param>
        /// <returns>List&lt;ProcessOutputAPIModel&gt;</returns>
        public List<ProcessOutputAPIModel> CloseAsn (ClosePurchProcessInputAPIModel body)
        {
             ApiResponse<List<ProcessOutputAPIModel>> localVarResponse = CloseAsnWithHttpInfo(body);
             return localVarResponse.Data;
        }
        ...
        /// <param name="body">Input data for ClosePurchProcess process.</param>
        /// <returns>ApiResponse of List&lt;ProcessOutputAPIModel&gt;</returns>
        public ApiResponse< List<ProcessOutputAPIModel> > CloseAsnWithHttpInfo (ClosePurchProcessInputAPIModel body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling AsnApi->CloseAsn");

            var localVarPath = "/beta/asn/closeAsn";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("CloseAsn", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="body">Input data for ClosePurchProcess process.</param>
        /// <returns>Task of List&lt;ProcessOutputAPIModel&gt;</returns>
        public async System.Threading.Tasks.Task<List<ProcessOutputAPIModel>> CloseAsnAsync (ClosePurchProcessInputAPIModel body)
        {
             ApiResponse<List<ProcessOutputAPIModel>> localVarResponse = await CloseAsnAsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body">Input data for ClosePurchProcess process.</param>
        /// <returns>Task of ApiResponse (List&lt;ProcessOutputAPIModel&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<ProcessOutputAPIModel>>> CloseAsnAsyncWithHttpInfo (ClosePurchProcessInputAPIModel body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling AsnApi->CloseAsn");
