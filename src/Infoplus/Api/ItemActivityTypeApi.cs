...
namespace Infoplus.Api
{
    ...
    /// </summary>
    public interface IItemActivityTypeApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ItemActivityTypeApi : IItemActivityTypeApi
    {
        ...
        public ApiResponse< ItemActivityType > GetItemActivityTypeByIdWithHttpInfo (string itemActivityTypeId)
        {
            ...
            var localVarPath = "/v3.0/itemActivityType/{itemActivityTypeId}";
            ...
            {
                Exception exception = ExceptionFactory("GetItemActivityTypeById", localVarResponse);
        ...
        public ApiResponse< List<ItemActivityType> > GetItemActivityTypeBySearchTextWithHttpInfo (string searchText = null, int? page = null, int? limit = null)
        {
            ...
            var localVarPath = "/v3.0/itemActivityType/search";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetItemActivityTypeBySearchText", localVarResponse);
                if (exception != null) throw exception;
            }
