...
namespace Infoplus.Api
{
    ...
    /// </summary>
    public interface ILoggedTimeTypeApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class LoggedTimeTypeApi : ILoggedTimeTypeApi
    {
        ...
        public ApiResponse< LoggedTimeType > GetLoggedTimeTypeByIdWithHttpInfo (string loggedTimeTypeId)
        {
            ...
            {
                Exception exception = ExceptionFactory("GetLoggedTimeTypeById", localVarResponse);
        ...
        public ApiResponse< List<LoggedTimeType> > GetLoggedTimeTypeBySearchTextWithHttpInfo (string searchText = null, int? page = null, int? limit = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetLoggedTimeTypeBySearchText", localVarResponse);
                if (exception != null) throw exception;
            }
