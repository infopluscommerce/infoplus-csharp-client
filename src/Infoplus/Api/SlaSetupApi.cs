...
namespace Infoplus.Api
{
    ...
    public interface ISlaSetupApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Infoplus.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="slaSetupId">Id of the slaSetup to add a file to</param>
        ...
        /// <param name="fileName">Name of file</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> AddSlaSetupFileWithHttpInfo (int? slaSetupId, string fileName);
        /// <summary>
        ...
        /// <param name="fileName">Name of file</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task AddSlaSetupFileAsync (int? slaSetupId, string fileName);
        ...
        /// <param name="fileName">Name of file</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> AddSlaSetupFileAsyncWithHttpInfo (int? slaSetupId, string fileName);
        /// <summary>
        /// Add new tags for a slaSetup.
        /// </summary>
        /// <remarks>
    ...
    public partial class SlaSetupApi : ISlaSetupApi
    {
        ...
        /// <summary>
        /// Attach a file to a slaSetup Adds a file to an existing slaSetup.
        /// </summary>
        /// <exception cref="Infoplus.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="slaSetupId">Id of the slaSetup to add a file to</param>
        /// <param name="fileName">Name of file</param>
        /// <returns></returns>
        public void AddSlaSetupFile (int? slaSetupId, string fileName)
        {
        ...
        /// <param name="fileName">Name of file</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> AddSlaSetupFileWithHttpInfo (int? slaSetupId, string fileName)
        {
            // verify the required parameter 'slaSetupId' is set
            if (slaSetupId == null)
                throw new ApiException(400, "Missing required parameter 'slaSetupId' when calling SlaSetupApi->AddSlaSetupFile");
            // verify the required parameter 'fileName' is set
            if (fileName == null)
                throw new ApiException(400, "Missing required parameter 'fileName' when calling SlaSetupApi->AddSlaSetupFile");

            var localVarPath = "/beta/slaSetup/{slaSetupId}/file/{fileName}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("AddSlaSetupFile", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="fileName">Name of file</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AddSlaSetupFileAsync (int? slaSetupId, string fileName)
        {
             await AddSlaSetupFileAsyncWithHttpInfo(slaSetupId, fileName);
        ...
        /// <param name="fileName">Name of file</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> AddSlaSetupFileAsyncWithHttpInfo (int? slaSetupId, string fileName)
        {
            // verify the required parameter 'slaSetupId' is set
            if (slaSetupId == null)
                throw new ApiException(400, "Missing required parameter 'slaSetupId' when calling SlaSetupApi->AddSlaSetupFile");
