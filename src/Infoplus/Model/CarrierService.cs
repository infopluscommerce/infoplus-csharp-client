...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CarrierService :  IEquatable<CarrierService>, IValidatableObject
    {
        /// <summary>
        ...
        public CarrierService(string FullEntityClassName = default(string))
        {
        ...
        {
            return this.Equals(input as CarrierService);
        }

        /// <summary>
        /// Returns true if CarrierService instances are equal
        /// </summary>
        /// <param name="input">Instance of CarrierService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CarrierService input)
        {
            if (input == null)
                return false;
