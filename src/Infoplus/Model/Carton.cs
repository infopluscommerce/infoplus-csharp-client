...
namespace Infoplus.Model
{
    ...
    public partial class Carton :  IEquatable<Carton>, IValidatableObject
    {
        ...
        public Carton(decimal? OrderNo = default(decimal?), int? CartonNo = default(int?), int? CartonTypeId = default(int?), string CartonLPN = default(string), decimal? WeightLbs = default(decimal?), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
