...
namespace Infoplus.Model
{
    ...
    public partial class CartonContent :  IEquatable<CartonContent>, IValidatableObject
    {
        ...
        public CartonContent(decimal? GroupOrderId = default(decimal?), decimal? OrderNo = default(decimal?), int? CartonId = default(int?), int? LineItemId = default(int?), string Location = default(string), int? Quantity = default(int?), int? QuantityScanned = default(int?), DateTime? Completed = default(DateTime?), string ToteId = default(string), string PickerId = default(string), string Status = default(string), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
