...
namespace Infoplus.Model
{
    ...
    public partial class CartonType :  IEquatable<CartonType>, IValidatableObject
    {
        ...
        /// <param name="InnerLengthIn">InnerLengthIn.</param>
        /// <param name="InnerWidthIn">InnerWidthIn.</param>
        /// <param name="InnerHeightIn">InnerHeightIn.</param>
        ...
        /// <param name="NoOfCavities">NoOfCavities.</param>
        /// <param name="MaterialDescription">MaterialDescription.</param>
        /// <param name="CustomFields">CustomFields.</param>
        public CartonType(string Abbreviation = default(string), string Name = default(string), decimal? LengthIn = default(decimal?), decimal? WidthIn = default(decimal?), decimal? HeightIn = default(decimal?), decimal? InnerLengthIn = default(decimal?), decimal? InnerWidthIn = default(decimal?), decimal? InnerHeightIn = default(decimal?), decimal? WeightLbs = default(decimal?), int? LobId = default(int?), bool? IsActive = false, int? PredefinedPackageTypeId = default(int?), string AlcoholContainer = default(string), int? NoOfCavities = default(int?), string MaterialDescription = default(string), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
        ...
        /// <summary>
        /// Gets or Sets NoOfCavities
        /// </summary>
        [DataMember(Name="noOfCavities", EmitDefaultValue=false)]
        public int? NoOfCavities { get; set; }

        /// <summary>
        /// Gets or Sets MaterialDescription
        /// </summary>
        [DataMember(Name="materialDescription", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NoOfCavities: ").Append(NoOfCavities).Append("\n");
        ...
        public bool Equals(CartonType input)
        {
            ...
            return 
                ...
                (
                    this.NoOfCavities == input.NoOfCavities ||
                    (this.NoOfCavities != null &&
                    this.NoOfCavities.Equals(input.NoOfCavities))
                ) && 
                (
                    this.MaterialDescription == input.MaterialDescription ||
                    (this.MaterialDescription != null &&
                    this.MaterialDescription.Equals(input.MaterialDescription))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NoOfCavities != null)
                    hashCode = hashCode * 59 + this.NoOfCavities.GetHashCode();
                if (this.MaterialDescription != null)
                    hashCode = hashCode * 59 + this.MaterialDescription.GetHashCode();
