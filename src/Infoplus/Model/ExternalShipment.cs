...
namespace Infoplus.Model
{
    ...
    public partial class ExternalShipment :  IEquatable<ExternalShipment>, IValidatableObject
    {
        ...
        public ExternalShipment(decimal? OrderId = default(decimal?), int? CarrierId = default(int?), int? ParcelAccountId = default(int?), int? ThirdPartyParcelAccountId = default(int?), decimal? Freight = default(decimal?), string TrackingNo = default(string), decimal? Dim1In = default(decimal?), decimal? Dim2In = default(decimal?), decimal? Dim3In = default(decimal?), decimal? WeightLbs = default(decimal?), decimal? DimWeight = default(decimal?), bool? Residential = false, string Zone = default(string), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
