...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FulfillmentProcess :  IEquatable<FulfillmentProcess>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FulfillmentProcess" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FulfillmentProcess() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FulfillmentProcess" /> class.
        /// </summary>
        /// <param name="WorkBatchIdList">WorkBatchIdList.</param>
        ...
        /// <param name="SelectAlternatePickLocation">SelectAlternatePickLocation (default to false).</param>
        /// <param name="FirstPickPosition">FirstPickPosition.</param>
        /// <param name="AutoCreateCycleCountWork">AutoCreateCycleCountWork (default to false).</param>
        /// <param name="AutoAdjustmentTolerance">AutoAdjustmentTolerance.</param>
        ...
        public FulfillmentProcess(List<int?> WorkBatchIdList = default(List<int?>), int? WarehouseId = default(int?), int? FulfillmentPlanId = default(int?), int? PickScanSchemeId = default(int?), string Status = default(string), int? OrderSmartFilterId = default(int?), int? LocationSmartFilterId = default(int?), string Version = default(string), bool? IsMassDistribution = false, int? PriorityCode = default(int?), int? CompletedPicks = default(int?), int? TotalPicks = default(int?), int? ShippedCasebreaks = default(int?), int? TotalCasebreaksToShip = default(int?), int? ShippedOrders = default(int?), int? TotalOrdersToShip = default(int?), int? CompletedToDo = default(int?), int? TotalToDo = default(int?), bool? CreatePickWork = false, string PickingRule = default(string), string PickBatchGroupId = default(string), string LayoutRule = default(string), string PickSortRule = default(string), string LocationSort = default(string), bool? SelectAlternatePickLocation = false, int? FirstPickPosition = default(int?), bool? AutoCreateCycleCountWork = false, int? AutoAdjustmentTolerance = default(int?), string PickListFormat = default(string), string PickListLayout = default(string), string PickListGroup = default(string), string PickListSort = default(string), string PickListLocationSort = default(string), string PickSummaryFormat = default(string), string PickSummaryLayout = default(string), string PickSummarySort = default(string), bool? CreatePickSummary = false, bool? CreatePickList = false, bool? PreGenerateParcelLabels = false, string LabelSort = default(string), DateTime? ShipDate = default(DateTime?), bool? AutoShipCasebreakCartons = false, bool? AutoShipOrders = false, bool? CartonizeOrders = false, int? CartonizationScriptId = default(int?), string CreatePackingSlip = default(string), int? OverridePackingSlipTemplateId = default(int?), bool? CreateOrderAssemblyGuide = false, string OrderAssemblyGuideLayout = default(string), string CreateOrderInvoice = default(string), int? OverrideOrderInvoiceTemplateId = default(int?), string CreateCartonGS1128Labels = default(string), string CreateLineItemEachGS1128Labels = default(string), bool? SendToExternalShippingSystem = false, int? ExternalShippingSystemId = default(int?), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
            ...
            // use default value if no "SelectAlternatePickLocation" provided
            if (SelectAlternatePickLocation == null)
            {
                this.SelectAlternatePickLocation = false;
            }
            else
            {
            ...
            // use default value if no "AutoCreateCycleCountWork" provided
            if (AutoCreateCycleCountWork == null)
            {
                this.AutoCreateCycleCountWork = false;
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets WorkBatchIdList
        /// </summary>
        [DataMember(Name="workBatchIdList", EmitDefaultValue=false)]
        public List<int?> WorkBatchIdList { get; set; }
        ...
        /// <summary>
        /// Gets or Sets BatchMaxSize
        /// </summary>
        [DataMember(Name="batchMaxSize", EmitDefaultValue=false)]
        public int? BatchMaxSize { get; private set; }

        /// <summary>
        /// Gets or Sets BatchMinSize
        /// </summary>
        [DataMember(Name="batchMinSize", EmitDefaultValue=false)]
        public int? BatchMinSize { get; private set; }

        /// <summary>
        /// Gets or Sets MaxCartons
        /// </summary>
        [DataMember(Name="maxCartons", EmitDefaultValue=false)]
        public int? MaxCartons { get; private set; }
        ...
        public int? MaxSKUsPerBatch { get; private set; }
        ...
        /// <summary>
        /// Gets or Sets SelectAlternatePickLocation
        /// </summary>
        [DataMember(Name="selectAlternatePickLocation", EmitDefaultValue=false)]
        public bool? SelectAlternatePickLocation { get; set; }
        ...
        /// <summary>
        /// Gets or Sets AutoCreateCycleCountWork
        /// </summary>
        [DataMember(Name="autoCreateCycleCountWork", EmitDefaultValue=false)]
        public bool? AutoCreateCycleCountWork { get; set; }

        /// <summary>
        /// Gets or Sets AutoAdjustmentTolerance
        /// </summary>
        [DataMember(Name="autoAdjustmentTolerance", EmitDefaultValue=false)]
        public int? AutoAdjustmentTolerance { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WorkBatchIdList: ").Append(WorkBatchIdList).Append("\n");
            ...
            sb.Append("  BatchMaxSize: ").Append(BatchMaxSize).Append("\n");
            sb.Append("  BatchMinSize: ").Append(BatchMinSize).Append("\n");
            ...
            sb.Append("  SelectAlternatePickLocation: ").Append(SelectAlternatePickLocation).Append("\n");
            sb.Append("  FirstPickPosition: ").Append(FirstPickPosition).Append("\n");
            sb.Append("  AutoCreateCycleCountWork: ").Append(AutoCreateCycleCountWork).Append("\n");
            sb.Append("  AutoAdjustmentTolerance: ").Append(AutoAdjustmentTolerance).Append("\n");
        ...
        {
            return this.Equals(input as FulfillmentProcess);
        }

        /// <summary>
        /// Returns true if FulfillmentProcess instances are equal
        /// </summary>
        /// <param name="input">Instance of FulfillmentProcess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FulfillmentProcess input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ProcessNo == input.ProcessNo ||
                    (this.ProcessNo != null &&
                    this.ProcessNo.Equals(input.ProcessNo))
                ) && 
                (
                    this.WorkBatchIdList == input.WorkBatchIdList ||
                    this.WorkBatchIdList != null &&
                    this.WorkBatchIdList.SequenceEqual(input.WorkBatchIdList)
                ) && 
                (
                ...
                (
                    this.BatchMaxSize == input.BatchMaxSize ||
                    (this.BatchMaxSize != null &&
                    this.BatchMaxSize.Equals(input.BatchMaxSize))
                ) && 
                (
                    this.BatchMinSize == input.BatchMinSize ||
                    (this.BatchMinSize != null &&
                    this.BatchMinSize.Equals(input.BatchMinSize))
                ) && 
                (
                ...
                (
                    ...
                    this.NumberOfOrders.Equals(input.NumberOfOrders))
                ) && 
                (
                    this.NumberOfLines == input.NumberOfLines ||
                    (this.NumberOfLines != null &&
                    this.NumberOfLines.Equals(input.NumberOfLines))
                ) && 
                (
                    this.NumberOfSKUs == input.NumberOfSKUs ||
                    (this.NumberOfSKUs != null &&
                    this.NumberOfSKUs.Equals(input.NumberOfSKUs))
                ) && 
                (
                ...
                (
                    this.ShippedCasebreaks == input.ShippedCasebreaks ||
                    (this.ShippedCasebreaks != null &&
                    this.ShippedCasebreaks.Equals(input.ShippedCasebreaks))
                ) && 
                (
                    this.TotalCasebreaksToShip == input.TotalCasebreaksToShip ||
                    (this.TotalCasebreaksToShip != null &&
                    this.TotalCasebreaksToShip.Equals(input.TotalCasebreaksToShip))
                ) && 
                (
                    this.ShippedOrders == input.ShippedOrders ||
                    (this.ShippedOrders != null &&
                    this.ShippedOrders.Equals(input.ShippedOrders))
                ) && 
                (
                    this.TotalOrdersToShip == input.TotalOrdersToShip ||
                    (this.TotalOrdersToShip != null &&
                    this.TotalOrdersToShip.Equals(input.TotalOrdersToShip))
                ) && 
                (
                ...
                (
                    this.SelectAlternatePickLocation == input.SelectAlternatePickLocation ||
                    (this.SelectAlternatePickLocation != null &&
                    this.SelectAlternatePickLocation.Equals(input.SelectAlternatePickLocation))
                ) && 
                (
                ...
                (
                    this.AutoCreateCycleCountWork == input.AutoCreateCycleCountWork ||
                    (this.AutoCreateCycleCountWork != null &&
                    this.AutoCreateCycleCountWork.Equals(input.AutoCreateCycleCountWork))
                ) && 
                (
                    this.AutoAdjustmentTolerance == input.AutoAdjustmentTolerance ||
                    (this.AutoAdjustmentTolerance != null &&
                    this.AutoAdjustmentTolerance.Equals(input.AutoAdjustmentTolerance))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProcessNo != null)
                    hashCode = hashCode * 59 + this.ProcessNo.GetHashCode();
                if (this.WorkBatchIdList != null)
                    hashCode = hashCode * 59 + this.WorkBatchIdList.GetHashCode();
                ...
                if (this.BatchMaxSize != null)
                    hashCode = hashCode * 59 + this.BatchMaxSize.GetHashCode();
                if (this.BatchMinSize != null)
                    hashCode = hashCode * 59 + this.BatchMinSize.GetHashCode();
                ...
                if (this.NumberOfLines != null)
                    hashCode = hashCode * 59 + this.NumberOfLines.GetHashCode();
                if (this.NumberOfSKUs != null)
                    hashCode = hashCode * 59 + this.NumberOfSKUs.GetHashCode();
                ...
                if (this.ShippedCasebreaks != null)
                    hashCode = hashCode * 59 + this.ShippedCasebreaks.GetHashCode();
                if (this.TotalCasebreaksToShip != null)
                    hashCode = hashCode * 59 + this.TotalCasebreaksToShip.GetHashCode();
                if (this.ShippedOrders != null)
                    hashCode = hashCode * 59 + this.ShippedOrders.GetHashCode();
                if (this.TotalOrdersToShip != null)
                    hashCode = hashCode * 59 + this.TotalOrdersToShip.GetHashCode();
                ...
                if (this.SelectAlternatePickLocation != null)
                    hashCode = hashCode * 59 + this.SelectAlternatePickLocation.GetHashCode();
                if (this.FirstPickPosition != null)
                    hashCode = hashCode * 59 + this.FirstPickPosition.GetHashCode();
                if (this.AutoCreateCycleCountWork != null)
                    hashCode = hashCode * 59 + this.AutoCreateCycleCountWork.GetHashCode();
                if (this.AutoAdjustmentTolerance != null)
                    hashCode = hashCode * 59 + this.AutoAdjustmentTolerance.GetHashCode();
