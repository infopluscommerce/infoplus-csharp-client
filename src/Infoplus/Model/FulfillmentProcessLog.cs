...
namespace Infoplus.Model
{
    ...
    public partial class FulfillmentProcessLog :  IEquatable<FulfillmentProcessLog>, IValidatableObject
    {
        ...
        /// <param name="ProcessNoId">ProcessNoId.</param>
        ...
        public FulfillmentProcessLog(int? Id = default(int?), DateTime? CreateDate = default(DateTime?), DateTime? ModifyDate = default(DateTime?), int? ProcessNoId = default(int?), int? WarehouseId = default(int?), decimal? OrderId = default(decimal?), int? LobId = default(int?), int? SkuId = default(int?), int? LocationId = default(int?), int? ItemReceiptId = default(int?), string AllocationIssueType = default(string), string Message = default(string), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
            this.Id = Id;
