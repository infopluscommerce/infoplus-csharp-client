...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetOrderWarehouseFulfillmentDataInput :  IEquatable<GetOrderWarehouseFulfillmentDataInput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GetOrderWarehouseFulfillmentDataInput);
        }

        /// <summary>
        /// Returns true if GetOrderWarehouseFulfillmentDataInput instances are equal
        /// </summary>
        /// <param name="input">Instance of GetOrderWarehouseFulfillmentDataInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetOrderWarehouseFulfillmentDataInput input)
        {
            if (input == null)
                return false;
