...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IntegrationPartner :  IEquatable<IntegrationPartner>, IValidatableObject
    {
        /// <summary>
        ...
        public IntegrationPartner(string FullEntityClassName = default(string))
        {
        ...
        {
            return this.Equals(input as IntegrationPartner);
        }

        /// <summary>
        /// Returns true if IntegrationPartner instances are equal
        /// </summary>
        /// <param name="input">Instance of IntegrationPartner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntegrationPartner input)
        {
            if (input == null)
                return false;
