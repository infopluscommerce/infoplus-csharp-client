...
namespace Infoplus.Model
{
    ...
    public partial class InventoryDetail :  IEquatable<InventoryDetail>, IValidatableObject
    {
        ...
        public InventoryDetail(int? WarehouseLocationId = default(int?), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>), string Sku = default(string))
        {
