...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InventoryStorageActivity :  IEquatable<InventoryStorageActivity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryStorageActivity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InventoryStorageActivity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryStorageActivity" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InventoryStorageActivity);
        }

        /// <summary>
        /// Returns true if InventoryStorageActivity instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryStorageActivity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryStorageActivity input)
        {
            if (input == null)
                return false;
