...
namespace Infoplus.Model
{
    ...
    public partial class ItemReceipt :  IEquatable<ItemReceipt>
    {
        ...
        public ItemReceipt(int? PoNoId = null, int? LobId = null, string LegacyPoNo = null, int? WarehouseId = null, DateTime? OrderDate = null, decimal? FactCost = null, decimal? MlCost = null, string Sku = null, int? OrderQuantity = null, DateTime? RequestedDeliveryDate = null, string UnitCode = null, string WrapCode = null, int? UnitsPerWrap = null, decimal? Cost = null, decimal? Sell = null, string PricingPer = null, decimal? MaxFreight = null, string ChargeFreight = null, decimal? MaxOther = null, DateTime? DistDate = null, DateTime? VoidDate = null, string FreezeAction = null, string RevDate = null, string ArtBack = null, string Origin = null, int? Sample = null, string SampleTo = null, int? MaxOvers = null, int? MaxUnders = null, int? ReceivedSfp = null, string BudgetCode = null, string AccountingCode = null, string TaxExempt = null, string Capitalize = null, string Accrual = null, int? OddQuantity = null, decimal? FreightCost = null, DateTime? ReceivedDate = null, int? ReceivedQuantity = null, int? FromProd = null, string SfpComplete = null, int? EndQuantity = null, decimal? EndVal = null, decimal? EndFact = null, int? InterimQuantity = null, decimal? InterimVal = null, decimal? InterimFact = null, DateTime? LastAct = null, decimal? WeightPerWrap = null, string Norcs = null, int? VendorId = null, int? BsVendor = null, int? MlVendor = null, int? ReceiptNo = null, string PaidFull = null, string EnteredBy = null, string ReceivedBy = null, int? LineNo = null, string ProdLot = null, int? UnitsPerCase = null, decimal? CaseWeight = null, decimal? Height = null, decimal? Width = null, decimal? Length = null, DateTime? DockTime = null, int? Impressions = null, int? AsnLine = null, Dictionary<string, Object> CustomFields = null)
        {
