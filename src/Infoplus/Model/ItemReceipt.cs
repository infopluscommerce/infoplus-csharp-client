...
namespace Infoplus.Model
{
    ...
    public partial class ItemReceipt :  IEquatable<ItemReceipt>, IValidatableObject
    {
        ...
        public ItemReceipt(string FullDescription = default(string), decimal? FactCost = default(decimal?), decimal? MlCost = default(decimal?), DateTime? RequestedDeliveryDate = default(DateTime?), string UnitCode = default(string), string WrapCode = default(string), int? UnitsPerWrap = default(int?), decimal? Cost = default(decimal?), decimal? SellPrice = default(decimal?), string PricingPer = default(string), decimal? MaxFreight = default(decimal?), string ChargeFreight = default(string), decimal? MaxOther = default(decimal?), DateTime? DistDate = default(DateTime?), DateTime? VoidDate = default(DateTime?), string FreezeAction = default(string), string RevDate = default(string), DateTime? ExpirationDate = default(DateTime?), string ArtBack = default(string), string Origin = default(string), int? Sample = default(int?), string SampleTo = default(string), int? ReceivedSfp = default(int?), string BudgetCode = default(string), string AccountingCode = default(string), string TaxExempt = default(string), string Capitalize = default(string), string Accrual = default(string), int? OddQuantity = default(int?), decimal? FreightCost = default(decimal?), DateTime? ReceivedDate = default(DateTime?), int? FromProd = default(int?), string SfpComplete = default(string), int? EndQuantity = default(int?), decimal? EndVal = default(decimal?), decimal? EndFact = default(decimal?), int? InterimQuantity = default(int?), decimal? InterimVal = default(decimal?), decimal? InterimFact = default(decimal?), DateTime? LastAct = default(DateTime?), decimal? WeightPerWrap = default(decimal?), string Norcs = default(string), int? VendorId = default(int?), int? BsVendor = default(int?), int? MlVendor = default(int?), int? ReceiptNo = default(int?), string PaidFull = default(string), int? LineNo = default(int?), string ProdLot = default(string), string ProductIdTag = default(string), int? UnitsPerInnerPack = default(int?), int? UnitsPerCase = default(int?), int? UnitsPerPallet = default(int?), decimal? CaseWeight = default(decimal?), decimal? Height = default(decimal?), decimal? Width = default(decimal?), decimal? Length = default(decimal?), DateTime? DockDate = default(DateTime?), int? Impressions = default(int?), int? AsnLine = default(int?), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
        ...
        public string LegacyPoNo { get; private set; }
        ...
        public int? MaxUnders { get; private set; }
