...
namespace Infoplus.Model
{
    ...
    public partial class JobTime :  IEquatable<JobTime>, IValidatableObject
    {
        ...
        public JobTime(int? SecondDuration = default(int?), int? UserId = default(int?), int? LobId = default(int?), int? JobTypeId = default(int?), string Note = default(string), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
