...
namespace Infoplus.Model
{
    ...
    public partial class Kit :  IEquatable<Kit>, IValidatableObject
    {
        ...
        public Kit(int? LobId = default(int?), string KitSKU = default(string), string PackagingType = default(string), string Other = default(string), DateTime? CreateDate = default(DateTime?), DateTime? ModifyDate = default(DateTime?), string Line1 = default(string), string Line2 = default(string), string Line3 = default(string), string Line4 = default(string), string Line5 = default(string), string Line6 = default(string), string Line7 = default(string), string Line8 = default(string), int? Touches = default(int?), int? MinInvQty = default(int?), int? MidInvQty = default(int?), int? MaxInvQty = default(int?), string IsKOD = default(string), string KodType = default(string), List<KitComponent> KitComponentList = default(List<KitComponent>), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
