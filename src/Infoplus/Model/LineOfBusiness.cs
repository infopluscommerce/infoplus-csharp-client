...
namespace Infoplus.Model
{
    ...
    public partial class LineOfBusiness :  IEquatable<LineOfBusiness>, IValidatableObject
    {
        ...
        public LineOfBusiness(string Name = default(string), string Code = default(string), string Label = default(string), int? DefaultWarehouseServiceTypeId = default(int?), int? DefaultSLAServiceDays = default(int?), string DefaultSLACutoffTime = default(string), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
            this.Name = Name;
            this.Code = Code;
            this.Label = Label;
