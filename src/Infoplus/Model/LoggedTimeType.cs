...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoggedTimeType :  IEquatable<LoggedTimeType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoggedTimeType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LoggedTimeType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LoggedTimeType" /> class.
        /// </summary>
        /// <param name="FullEntityClassName">FullEntityClassName.</param>
        public LoggedTimeType(string FullEntityClassName = default(string))
        {
        ...
        {
            return this.Equals(input as LoggedTimeType);
        }

        /// <summary>
        /// Returns true if LoggedTimeType instances are equal
        /// </summary>
        /// <param name="input">Instance of LoggedTimeType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoggedTimeType input)
        {
            if (input == null)
                return false;
