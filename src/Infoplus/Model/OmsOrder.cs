...
namespace Infoplus.Model
{
    ...
    public partial class OmsOrder :  IEquatable<OmsOrder>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets EnteredById
        /// </summary>
        [DataMember(Name="enteredById", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EnteredById: ").Append(EnteredById).Append("\n");
        ...
        public bool Equals(OmsOrder input)
        {
            ...
            return 
                ...
                (
                    this.EnteredById == input.EnteredById ||
                    (this.EnteredById != null &&
                    this.EnteredById.Equals(input.EnteredById))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnteredById != null)
                    hashCode = hashCode * 59 + this.EnteredById.GetHashCode();
                if (this.Id != null)
