...
namespace Infoplus.Model
{
    ...
    public partial class OrderSource :  IEquatable<OrderSource>, IValidatableObject
    {
        ...
        public OrderSource(int? LobId = default(int?), string Name = default(string), string PackingNotes = default(string), bool? RequireCartonizedASN = false, bool? UsesReservations = false, bool? RequireGS1128Label = false, string ShippingNotes = default(string), int? PackingSlipId = default(int?), int? OrderInvoiceId = default(int?), int? OrderConfirmationEmailId = default(int?), int? ShipmentConfirmationEmailId = default(int?), int? DefaultServiceTypeId = default(int?), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
