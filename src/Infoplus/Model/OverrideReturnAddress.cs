...
namespace Infoplus.Model
{
    ...
    public partial class OverrideReturnAddress :  IEquatable<OverrideReturnAddress>, IValidatableObject
    {
        ...
        public OverrideReturnAddress(int? LobId = default(int?), int? WarehouseId = default(int?), int? OrderSourceId = default(int?), string Name = default(string), string Attention = default(string), string Street = default(string), string Street2 = default(string), string Street3Province = default(string), string City = default(string), string State = default(string), string Zip = default(string), string Country = default(string), string Phone = default(string), string Email = default(string), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
            ...
            if (Country == null)
            {
                throw new InvalidDataException("Country is a required property for OverrideReturnAddress and cannot be null");
            }
            else
            {
