...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PackingSlipTemplateLineItemDescriptionEnum :  IEquatable<PackingSlipTemplateLineItemDescriptionEnum>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackingSlipTemplateLineItemDescriptionEnum" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PackingSlipTemplateLineItemDescriptionEnum() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PackingSlipTemplateLineItemDescriptionEnum" /> class.
        /// </summary>
        /// <param name="FullEntityClassName">FullEntityClassName.</param>
        public PackingSlipTemplateLineItemDescriptionEnum(string FullEntityClassName = default(string))
        {
        ...
        {
            return this.Equals(input as PackingSlipTemplateLineItemDescriptionEnum);
        }

        /// <summary>
        /// Returns true if PackingSlipTemplateLineItemDescriptionEnum instances are equal
        /// </summary>
        /// <param name="input">Instance of PackingSlipTemplateLineItemDescriptionEnum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PackingSlipTemplateLineItemDescriptionEnum input)
        {
            if (input == null)
                return false;
