...
namespace Infoplus.Model
{
    ...
    public partial class ParcelAccount :  IEquatable<ParcelAccount>, IValidatableObject
    {
        ...
        /// <param name="ManifestPartner">ManifestPartner.</param>
        ...
        public ParcelAccount(string CarrierCompany = default(string), string AccountNo = default(string), int? LobId = default(int?), int? OrderSourceId = default(int?), string Name = default(string), int? ManifestPartner = default(int?), string ManifestPartnerId = default(string), string ManifestPartnerCredentials = default(string), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
        ...
        /// <summary>
        /// Gets or Sets ManifestPartner
        /// </summary>
        [DataMember(Name="manifestPartner", EmitDefaultValue=false)]
        public int? ManifestPartner { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ManifestPartner: ").Append(ManifestPartner).Append("\n");
        ...
        public bool Equals(ParcelAccount input)
        {
            ...
            return 
                ...
                (
                    this.ManifestPartner == input.ManifestPartner ||
                    (this.ManifestPartner != null &&
                    this.ManifestPartner.Equals(input.ManifestPartner))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ManifestPartner != null)
                    hashCode = hashCode * 59 + this.ManifestPartner.GetHashCode();
