...
namespace Infoplus.Model
{
    ...
    public partial class ParcelAccount :  IEquatable<ParcelAccount>, IValidatableObject
    {
        ...
        public ParcelAccount(string Carrier = default(string), string AccountNo = default(string), string Name = default(string), string ManifestPartnerId = default(string), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
