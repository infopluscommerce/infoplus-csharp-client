...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PredefinedCarton :  IEquatable<PredefinedCarton>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PredefinedCarton" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PredefinedCarton() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PredefinedCarton" /> class.
        /// </summary>
        /// <param name="FullEntityClassName">FullEntityClassName.</param>
        public PredefinedCarton(string FullEntityClassName = default(string))
        {
        ...
        {
            return this.Equals(input as PredefinedCarton);
        }

        /// <summary>
        /// Returns true if PredefinedCarton instances are equal
        /// </summary>
        /// <param name="input">Instance of PredefinedCarton to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PredefinedCarton input)
        {
            if (input == null)
                return false;
