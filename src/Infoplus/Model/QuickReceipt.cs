...
namespace Infoplus.Model
{
    ...
    public partial class QuickReceipt :  IEquatable<QuickReceipt>, IValidatableObject
    {
        ...
        /// <param name="ItemSerials">ItemSerials.</param>
        ...
        /// </summary>
        [DataMember(Name="itemSerials", EmitDefaultValue=false)]
        public List<string> ItemSerials { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ItemSerials: ").Append(ItemSerials).Append("\n");
        ...
        public bool Equals(QuickReceipt input)
        {
            ...
            return 
                ...
                (
                    this.ItemSerials == input.ItemSerials ||
                    this.ItemSerials != null &&
                    this.ItemSerials.SequenceEqual(input.ItemSerials)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ItemSerials != null)
                    hashCode = hashCode * 59 + this.ItemSerials.GetHashCode();
