...
namespace Infoplus.Model
{
    ...
    public partial class ReceivingWorksheetLineItem :  IEquatable<ReceivingWorksheetLineItem>, IValidatableObject
    {
        ...
        public ReceivingWorksheetLineItem(int? ReceivingQty = default(int?), string UnitCode = default(string), string WrapCode = default(string), int? UnitsPerWrap = default(int?), int? UnitsPerCase = default(int?), int? CasesPerPallet = default(int?), decimal? WeightPerWrap = default(decimal?), decimal? WeightPerCase = default(decimal?), string ProductionLot = default(string), string ProductIdTag = default(string), string RevisionDate = default(string), string Origin = default(string), decimal? CartonLength = default(decimal?), decimal? CartonWidth = default(decimal?), decimal? CartonHeight = default(decimal?), List<ReceivingWorksheetPutAwayPlan> PutAwayPlans = default(List<ReceivingWorksheetPutAwayPlan>), int? Quantity = default(int?), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
        ...
        public bool Equals(ReceivingWorksheetLineItem input)
        {
            ...
            return 
                ...
                (
                    this.CasesPerPallet == input.CasesPerPallet ||
                    (this.CasesPerPallet != null &&
                    this.CasesPerPallet.Equals(input.CasesPerPallet))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CasesPerPallet != null)
                    hashCode = hashCode * 59 + this.CasesPerPallet.GetHashCode();
