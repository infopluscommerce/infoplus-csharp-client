...
namespace Infoplus.Model
{
    ...
    public partial class ReqParcelAccessoryData :  IEquatable<ReqParcelAccessoryData>, IValidatableObject
    {
        ...
        public ReqParcelAccessoryData(string Accessory = default(string), string Amount = default(string), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
