...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReturnShipment :  IEquatable<ReturnShipment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReturnShipment" /> class.
        /// </summary>
        ...
        public ReturnShipment(int? Id = default(int?), int? WarehouseId = default(int?), List<decimal?> OrderNoList = default(List<decimal?>), int? CartonNo = default(int?), int? NumberOfCartons = default(int?), bool? Shipped = false, bool? Casebreak = false, int? CarrierServiceId = default(int?), decimal? Dim1In = default(decimal?), decimal? Dim2In = default(decimal?), decimal? Dim3In = default(decimal?), string EstimatedZone = default(string), string CarrierCompany = default(string), int? CartonId = default(int?), int? CartonTypeId = default(int?), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
            // to ensure "WarehouseId" is required (not null)
            if (WarehouseId == null)
            {
                throw new InvalidDataException("WarehouseId is a required property for ReturnShipment and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CarrierCompany is a required property for ReturnShipment and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ReturnShipment);
        }

        /// <summary>
        /// Returns true if ReturnShipment instances are equal
        /// </summary>
        /// <param name="input">Instance of ReturnShipment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReturnShipment input)
        {
            if (input == null)
                return false;
