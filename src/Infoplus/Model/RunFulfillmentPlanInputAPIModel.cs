...
namespace Infoplus.Model
{
    ...
    public partial class RunFulfillmentPlanInputAPIModel :  IEquatable<RunFulfillmentPlanInputAPIModel>, IValidatableObject
    {
        ...
        public RunFulfillmentPlanInputAPIModel(List<decimal?> OrderNoList = default(List<decimal?>), int? FulfillmentPlanId = default(int?), int? FirstPickPosition = default(int?), DateTime? ShipDate = default(DateTime?))
        {
