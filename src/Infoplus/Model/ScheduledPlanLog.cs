...
namespace Infoplus.Model
{
    ...
    public partial class ScheduledPlanLog :  IEquatable<ScheduledPlanLog>, IValidatableObject
    {
        ...
        public ScheduledPlanLog(string Plan = default(string), string Status = default(string), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
