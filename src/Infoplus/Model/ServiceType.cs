...
namespace Infoplus.Model
{
    ...
    public partial class ServiceType :  IEquatable<ServiceType>, IValidatableObject
    {
        ...
        public ServiceType(string FullEntityClassName = default(string))
        {
        ...
        public bool Equals(ServiceType input)
        {
            ...
            return 
                (
                    this._ServiceType == input._ServiceType ||
                    (this._ServiceType != null &&
                    this._ServiceType.Equals(input._ServiceType))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._ServiceType != null)
                    hashCode = hashCode * 59 + this._ServiceType.GetHashCode();
                if (this.Label != null)
