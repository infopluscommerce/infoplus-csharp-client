...
namespace Infoplus.Model
{
    ...
    public partial class Warehouse :  IEquatable<Warehouse>, IValidatableObject
    {
        ...
        public Warehouse(string Name = default(string), string Address = default(string), string Company = default(string), string Street1 = default(string), string Street2 = default(string), string Street3 = default(string), string City = default(string), string State = default(string), string Zip = default(string), string Country = default(string), string Phone = default(string), string LocationBarcodePrefix = default(string), string LpnPrefix = default(string), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
