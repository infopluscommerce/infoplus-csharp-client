...
namespace Infoplus.Model
{
    ...
    public partial class Work :  IEquatable<Work>, IValidatableObject
    {
        ...
        public Work(int? SourceWarehouseId = default(int?), int? SourceBuildingId = default(int?), string SourceLocation = default(string), int? DestinationWarehouseId = default(int?), int? DestinationBuildingId = default(int?), string DestinationLocation = default(string), string Type = default(string), int? PriorityCode = default(int?), string Status = default(string), int? UserId = default(int?), int? WorkBatchId = default(int?), Dictionary<string, Object> CustomFields = default(Dictionary<string, Object>))
        {
