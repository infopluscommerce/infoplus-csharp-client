...
namespace Infoplus.Api
{
    ...
    /// </summary>
    public interface IIntegrationPartnerApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class IntegrationPartnerApi : IIntegrationPartnerApi
    {
        ...
        public ApiResponse< IntegrationPartner > GetIntegrationPartnerByIdWithHttpInfo (string integrationPartnerId)
        {
            ...
            {
                Exception exception = ExceptionFactory("GetIntegrationPartnerById", localVarResponse);
        ...
        public ApiResponse< List<IntegrationPartner> > GetIntegrationPartnerBySearchTextWithHttpInfo (string searchText = null, int? page = null, int? limit = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetIntegrationPartnerBySearchText", localVarResponse);
                if (exception != null) throw exception;
            }
