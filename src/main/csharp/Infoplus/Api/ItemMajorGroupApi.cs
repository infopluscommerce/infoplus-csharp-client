...
namespace Infoplus.Api
{
    ...
    /// </summary>
    public interface IItemMajorGroupApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ItemMajorGroupApi : IItemMajorGroupApi
    {
        ...
        public ApiResponse< List<ItemMajorGroup> > GetItemMajorGroupBySearchTextWithHttpInfo (string searchText = null, int? page = null, int? limit = null)
        {
            ...
            {
                Exception exception = ExceptionFactory("GetItemMajorGroupBySearchText", localVarResponse);
        ...
        public ApiResponse< ItemMajorGroup > GetTranslateMajorGroupByIdWithHttpInfo (string itemMajorGroupId)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetTranslateMajorGroupById", localVarResponse);
                if (exception != null) throw exception;
            }
