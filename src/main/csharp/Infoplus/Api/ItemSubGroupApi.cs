...
namespace Infoplus.Api
{
    ...
    /// </summary>
    public interface IItemSubGroupApi
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class ItemSubGroupApi : IItemSubGroupApi
    {
        /// <summary>
        ...
        public ApiResponse< List<ItemSubGroup> > GetItemSubGroupBySearchTextWithHttpInfo (string searchText = null, int? page = null, int? limit = null)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling GetItemSubGroupBySearchText: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling GetItemSubGroupBySearchText: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        public ApiResponse< ItemSubGroup > GetTranslateSubGroupByIdWithHttpInfo (string itemSubGroupId)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling GetTranslateSubGroupById: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling GetTranslateSubGroupById: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        {
            // verify the required parameter 'itemSubGroupId' is set
            if (itemSubGroupId == null) throw new ApiException(400, "Missing required parameter 'itemSubGroupId' when calling GetTranslateSubGroupById");
