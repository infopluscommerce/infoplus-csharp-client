...
namespace Infoplus.Api
{
    ...
    public class ReplenishmentPlanApi : IReplenishmentPlanApi
    {
        ...
        public ApiResponse< ReplenishmentPlan > GetDuplicateReplenishmentPlanByIdWithHttpInfo (int? replenishmentPlanId)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling GetDuplicateReplenishmentPlanById: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling GetDuplicateReplenishmentPlanById: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
