...
namespace Infoplus.Model
{
    ...
    { 
        ...
        public CartonContent(double? GroupOrderId = null, double? OrderNo = null, int? CartonId = null, int? LineItemId = null, string Location = null, int? Quantity = null, int? QuantityScanned = null, DateTime? Completed = null, string ToteId = null, string PickerId = null, string Status = null, Dictionary<string, Object> CustomFields = null)
        {
        ...
        public bool Equals(CartonContent other)
        {
            ...
            return 
                ...
                (
                    ...
                    this.CartonId != null &&
                    this.CartonId.Equals(other.CartonId)
                ) && 
                (
