...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExecuteQuickReceiptInputAPIModel :  IEquatable<ExecuteQuickReceiptInputAPIModel>
    { 
        ...
        public ExecuteQuickReceiptInputAPIModel(List<int?> IdList = null)
        {
            this.IdList = IdList;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ExecuteQuickReceiptInputAPIModel);
        }

        /// <summary>
        /// Returns true if ExecuteQuickReceiptInputAPIModel instances are equal
        /// </summary>
        /// <param name="other">Instance of ExecuteQuickReceiptInputAPIModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExecuteQuickReceiptInputAPIModel other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
