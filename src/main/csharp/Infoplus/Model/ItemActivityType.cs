...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ItemActivityType :  IEquatable<ItemActivityType>
    { 
        ...
        public ItemActivityType(string FullEntityClassName = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ItemActivityType);
        }

        /// <summary>
        /// Returns true if ItemActivityType instances are equal
        /// </summary>
        /// <param name="other">Instance of ItemActivityType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemActivityType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
