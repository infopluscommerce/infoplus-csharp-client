...
namespace Infoplus.Model
{
    ...
    { 
        ...
        /// <param name="FreezeAction">FreezeAction (required).</param>
        ...
        /// <param name="ReceivedSfp">ReceivedSfp (required).</param>
        ...
        public ItemReceipt(string PoNo = null, int? LobId = null, string LegacyPoNo = null, int? WarehouseId = null, DateTime? OrderDate = null, double? FactCost = null, double? MlCost = null, string Sku = null, int? OrderQuantity = null, DateTime? RequestedDeliveryDate = null, string UnitCode = null, string WrapCode = null, int? UnitsPerWrap = null, double? Cost = null, double? Sell = null, string PricingPer = null, double? MaxFreight = null, string ChargeFreight = null, double? MaxOther = null, DateTime? DistDate = null, DateTime? VoidDate = null, string FreezeAction = null, string RevDate = null, string ArtBack = null, string Origin = null, int? Sample = null, string SampleTo = null, int? MaxOvers = null, int? MaxUnders = null, int? ReceivedSfp = null, string BudgetCode = null, string AccountingCode = null, string TaxExempt = null, string Capitalize = null, string Accrual = null, int? OddQuantity = null, double? FreightCost = null, DateTime? ReceivedDate = null, int? ReceivedQuantity = null, int? FromProd = null, string SfpComplete = null, int? EndQuantity = null, double? EndVal = null, double? EndFact = null, int? InterimQuantity = null, double? InterimVal = null, double? InterimFact = null, DateTime? LastAct = null, double? WeightPerWrap = null, string Norcs = null, int? VendorId = null, int? BsVendor = null, int? MlVendor = null, int? ReceiptNo = null, string PaidFull = null, string EnteredBy = null, string ReceivedBy = null, int? LineNo = null, string ProdLot = null, int? UnitsPerCase = null, double? CaseWeight = null, double? Height = null, double? Width = null, double? Length = null, DateTime? DockTime = null, int? Impressions = null, int? AsnLine = null)
        {
            ...
            if (WarehouseId == null)
            {
                throw new InvalidDataException("WarehouseId is a required property for ItemReceipt and cannot be null");
            }
            else
            {
            ...
            if (Sku == null)
            {
                throw new InvalidDataException("Sku is a required property for ItemReceipt and cannot be null");
            }
            else
            {
                this.Sku = Sku;
            ...
            // to ensure "FreezeAction" is required (not null)
            if (FreezeAction == null)
            {
                throw new InvalidDataException("FreezeAction is a required property for ItemReceipt and cannot be null");
            }
            else
            {
            ...
            // to ensure "ReceivedSfp" is required (not null)
            if (ReceivedSfp == null)
            {
                throw new InvalidDataException("ReceivedSfp is a required property for ItemReceipt and cannot be null");
            }
            else
            {
