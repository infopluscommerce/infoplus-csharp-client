...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JobTimeActivity :  IEquatable<JobTimeActivity>
    { 
        ...
        public JobTimeActivity(int? SecondDuration = null, int? UserId = null, string Email = null, int? LobId = null, int? JobTypeId = null, string JobTypeName = null, string Note = null, Dictionary<string, Object> CustomFields = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as JobTimeActivity);
        }

        /// <summary>
        /// Returns true if JobTimeActivity instances are equal
        /// </summary>
        /// <param name="other">Instance of JobTimeActivity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobTimeActivity other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.JobTypeName.Equals(other.JobTypeName)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.JobTypeName != null)
                    hash = hash * 59 + this.JobTypeName.GetHashCode();
