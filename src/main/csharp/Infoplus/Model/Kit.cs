...
namespace Infoplus.Model
{
    ...
    { 
        ...
        /// <param name="KitSKUId">KitSKUId (required).</param>
        ...
        public Kit(int? LobId = null, int? KitSKUId = null, string PackagingType = null, string Other = null, DateTime? CreateDate = null, DateTime? ModifyDate = null, string Line1 = null, string Line2 = null, string Line3 = null, string Line4 = null, string Line5 = null, string Line6 = null, string Line7 = null, string Line8 = null, int? Touches = null, int? MinInvQty = null, int? MidInvQty = null, int? MaxInvQty = null, string IsKOD = null, string KodType = null, Dictionary<string, Object> CustomFields = null)
        {
            ...
            // to ensure "KitSKUId" is required (not null)
            if (KitSKUId == null)
            {
                throw new InvalidDataException("KitSKUId is a required property for Kit and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets KitSKUId
        /// </summary>
        [DataMember(Name="kitSKUId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  KitSKUId: ").Append(KitSKUId).Append("\n");
        ...
        public bool Equals(Kit other)
        {
            ...
            return 
                ...
                (
                    this.KitSKUId == other.KitSKUId ||
                    this.KitSKUId != null &&
                    this.KitSKUId.Equals(other.KitSKUId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.KitSKUId != null)
                    hash = hash * 59 + this.KitSKUId.GetHashCode();
