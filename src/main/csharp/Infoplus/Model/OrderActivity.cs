...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderActivity :  IEquatable<OrderActivity>
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OrderActivity);
        }

        /// <summary>
        /// Returns true if OrderActivity instances are equal
        /// </summary>
        /// <param name="other">Instance of OrderActivity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderActivity other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.ReqStatusName == other.ReqStatusName ||
                    this.ReqStatusName != null &&
                    this.ReqStatusName.Equals(other.ReqStatusName)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReqStatusName != null)
                    hash = hash * 59 + this.ReqStatusName.GetHashCode();
