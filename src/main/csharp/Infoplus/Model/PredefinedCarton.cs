...
namespace Infoplus.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PredefinedCarton :  IEquatable<PredefinedCarton>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PredefinedCarton" /> class.
        /// Initializes a new instance of the <see cref="PredefinedCarton" />class.
        /// </summary>
        /// <param name="FullEntityClassName">FullEntityClassName.</param>

        public PredefinedCarton(string FullEntityClassName = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PredefinedCarton);
        }

        /// <summary>
        /// Returns true if PredefinedCarton instances are equal
        /// </summary>
        /// <param name="other">Instance of PredefinedCarton to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PredefinedCarton other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
