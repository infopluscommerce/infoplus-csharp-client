...
namespace Infoplus.Model
{
    ...
    { 
        ...
        public QuickReceipt(int? WarehouseId = null, int? LobId = null, int? LocationId = null, int? Quantity = null, int? VendorId = null, string Carrier = null, string UnitCode = null, string WrapCode = null, double? WeightPerWrap = null, int? UnitsPerWrap = null, int? UnitsPerCase = null, int? CasesPerPallet = null, double? CaseWeight = null, string ProductionLot = null, string RevisionDate = null, string Origin = null, double? CartonLength = null, double? CartonWidth = null, double? CartonHeight = null, double? Cost = null, double? Sell = null, string PricingPer = null, string Sku = null)
        {
