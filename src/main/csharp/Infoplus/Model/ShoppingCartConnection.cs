    ...
    { 
        ...
        public bool Equals(ShoppingCartConnection other)
        {
            ...
            return 
                ...
                (
                    this.InventoryLevelWarehouseControls == other.InventoryLevelWarehouseControls ||
                    this.InventoryLevelWarehouseControls != null &&
                    this.InventoryLevelWarehouseControls.Equals(other.InventoryLevelWarehouseControls)
                ) && 
                (
                    this.WarehouseList == other.WarehouseList ||
                    this.WarehouseList != null &&
                    this.WarehouseList.SequenceEqual(other.WarehouseList)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InventoryLevelWarehouseControls != null)
                    hash = hash * 59 + this.InventoryLevelWarehouseControls.GetHashCode();
                
                if (this.WarehouseList != null)
                    hash = hash * 59 + this.WarehouseList.GetHashCode();
